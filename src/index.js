...
app.get('/listToolsSSE', async (req, res) => {
    ...
    // Keine Verbindungspufferung durch Proxies:
    ...
    try {
        ...
        // 2) \n
        // => gesamt: "data: {tools: [...]} \n\n"
        const jsonData = JSON.stringify(toolsObject);

        res.write(`data: ${jsonData}\n\n`);

        // Das war’s – normal kann man die Verbindung offenhalten,
        // hier reicht evtl. ein einmaliges Senden und dann .end().
        // Willst du fortlaufend Daten schicken, lässt du die Verbindung offen.
        // Falls nur ein Datensatz gesendet wird, kann man schließen:
        res.end();
    } catch (err) {
        console.error('Fehler beim Senden via SSE:', err);
        // Falls ein Fehler passiert, beenden wir die Verbindung:
        res.end();
    }
});
