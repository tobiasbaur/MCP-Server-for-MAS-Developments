...
- [**Configuration Description**](#configuration-description)
 ...
 - [Logging](#logging)
  ...
  - [Feature Activation/Deactivation](#feature-activationdeactivation)
    ...
    - [ENABLE_LOGOUT](#enable-logout)
    - [ENABLE_CHAT](#enable-chat)
    - [ENABLE_CONTINUE_CHAT](#enable-continue-chat)
    - [ENABLE_GET_CHAT_INFO](#enable-get-chat-info)
    - [ENABLE_DELETE_ALL_CHATS](#enable-delete-all-chats)
    - [ENABLE_DELETE_CHAT](#enable-delete-chat)
    - [ENABLE_LIST_GROUPS](#enable-list-groups)
    - [ENABLE_STORE_GROUP](#enable-store-group)
    - [ENABLE_DELETE_GROUP](#enable-delete-group)
    - [ENABLE_CREATE_SOURCE](#enable-create-source)
    - [ENABLE_EDIT_SOURCE](#enable-edit-source)
    - [ENABLE_DELETE_SOURCE](#enable-delete-source)
    - [ENABLE_GET_SOURCE](#enable-get-source)
    - [ENABLE_LIST_SOURCES](#enable-list-sources)
    - [ENABLE_STORE_USER](#enable-store-user)
    - [ENABLE_EDIT_USER](#enable-edit-user)
    - [ENABLE_DELETE_USER](#enable-delete-user)
    - [ENABLE_REACTIVATE_USER](#enable-reactivate-user)
